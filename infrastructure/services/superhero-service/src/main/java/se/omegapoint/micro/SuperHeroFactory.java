...
public class SuperHeroFactory {
    ...
    private final static Logger logger = LoggerFactory.getLogger(SuperHeroFactory.class);
    ...
    public SuperHero randomSuperHero() {
        ...
        ResponseEntity<SuperPowersDTO> superPowerResponse = restTemplate.getForEntity("http://superpower-service/superpowers", SuperPowersDTO.class);

        logger.info("Fetching galaxy for hero");
        ResponseEntity<Galaxy> galaxy = restTemplate.getForEntity("http://galaxy-service/galaxy", Galaxy.class);
